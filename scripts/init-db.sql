...
('HK-4', '10:30:00', 'Spinning', 'Room D1', 'James Lee', '45 min', 15, 'green', CURDATE(), 'Hong Kong'),
...
INSERT INTO classes (id, time, name, room, instructor, duration, spots, color, date, location) VALUES
('HK-1', '07:00:00', 'Yoga', 'Room B1', 'Amy Rodriguez', '60 min', 10, 'pink', DATE_ADD(CURDATE(), INTERVAL 1 DAY), 'Hong Kong'),
('HK-2', '08:30:00', 'Spinning', 'Room D1', 'James Lee', '45 min', 12, 'green', DATE_ADD(CURDATE(), INTERVAL 1 DAY), 'Hong Kong'),
('HK-3', '10:00:00', 'HIIT', 'Room A1', 'Sarah Johnson', '45 min', 8, 'blue', DATE_ADD(CURDATE(), INTERVAL 1 DAY), 'Hong Kong'),
('HK-4', '11:30:00', 'Pilates', 'Room C2', 'Emma Wilson', '50 min', 6, 'yellow', DATE_ADD(CURDATE(), INTERVAL 1 DAY), 'Hong Kong'),
('HK-5', '13:00:00', 'Boxing', 'Room A2', 'Lisa Park', '60 min', 14, 'blue', DATE_ADD(CURDATE(), INTERVAL 1 DAY), 'Hong Kong'),
('HK-6', '17:00:00', 'Strength', 'Room B1', 'David Kim', '55 min', 9, 'pink', DATE_ADD(CURDATE(), INTERVAL 1 DAY), 'Hong Kong');

-- Insert sample classes for tomorrow
INSERT INTO classes (id, time, name, room, instructor, duration, spots, color, date, location) VALUES
('HK-1', '07:00:00', 'Yoga', 'Room B1', 'Amy Rodriguez', '60 min', 10, 'pink', DATE_ADD(CURDATE(), INTERVAL 2 DAY), 'Hong Kong'),
('HK-2', '08:30:00', 'Spinning', 'Room D1', 'James Lee', '45 min', 12, 'green', DATE_ADD(CURDATE(), INTERVAL 2 DAY), 'Hong Kong'),
('HK-3', '10:00:00', 'HIIT', 'Room A1', 'Sarah Johnson', '45 min', 8, 'blue', DATE_ADD(CURDATE(), INTERVAL 2 DAY), 'Hong Kong'),
('HK-4', '11:30:00', 'Pilates', 'Room C2', 'Emma Wilson', '50 min', 6, 'yellow', DATE_ADD(CURDATE(), INTERVAL 2 DAY), 'Hong Kong'),
('HK-5', '13:00:00', 'Boxing', 'Room A2', 'Lisa Park', '60 min', 14, 'blue', DATE_ADD(CURDATE(), INTERVAL 2 DAY), 'Hong Kong'),
('HK-6', '17:00:00', 'Strength', 'Room B1', 'David Kim', '55 min', 9, 'pink', DATE_ADD(CURDATE(), INTERVAL 2 DAY), 'Hong Kong');
