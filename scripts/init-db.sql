...
INSERT INTO classes (class_id, time, name, room, instructor, duration, spots, class_size,color, date, location) VALUES
('HK-21', '07:00:00', 'Yoga', 'Room B1', 'Amy Rodriguez', '60 min', 10,10, 'pink', DATE_ADD(CURDATE(), INTERVAL 1 DAY), 'Hong Kong'),
('HK-22', '08:30:00', 'Spinning', 'Room D1', 'James Lee', '45 min', 12,12, 'green', DATE_ADD(CURDATE(), INTERVAL 1 DAY), 'Hong Kong'),
('HK-23', '10:00:00', 'HIIT', 'Room A1', 'Sarah Johnson', '45 min', 8,8, 'blue', DATE_ADD(CURDATE(), INTERVAL 1 DAY), 'Hong Kong'),
('HK-24', '11:30:00', 'Pilates', 'Room C2', 'Emma Wilson', '50 min', 6,6, 'yellow', DATE_ADD(CURDATE(), INTERVAL 1 DAY), 'Hong Kong'),
('HK-25', '13:00:00', 'Boxing', 'Room A2', 'Lisa Park', '60 min', 14,14, 'blue', DATE_ADD(CURDATE(), INTERVAL 1 DAY), 'Hong Kong'),
('HK-26', '17:00:00', 'Strength', 'Room B1', 'David Kim', '55 min', 9,9, 'pink', DATE_ADD(CURDATE(), INTERVAL 1 DAY), 'Hong Kong');

-- Insert sample classes for tomorrow
INSERT INTO classes (class_id, time, name, room, instructor, duration, spots, class_size,color, date, location) VALUES
('HK-11', '07:00:00', 'Yoga', 'Room B1', 'Amy Rodriguez', '60 min', 10, 10,'pink', DATE_ADD(CURDATE(), INTERVAL 2 DAY), 'Hong Kong'),
('HK-12', '08:30:00', 'Spinning', 'Room D1', 'James Lee', '45 min', 12, 12,'green', DATE_ADD(CURDATE(), INTERVAL 2 DAY), 'Hong Kong'),
('HK-13', '10:00:00', 'HIIT', 'Room A1', 'Sarah Johnson', '45 min', 8, 8,'blue', DATE_ADD(CURDATE(), INTERVAL 2 DAY), 'Hong Kong'),
('HK-14', '11:30:00', 'Pilates', 'Room C2', 'Emma Wilson', '50 min', 6, 6,'yellow', DATE_ADD(CURDATE(), INTERVAL 2 DAY), 'Hong Kong'),
('HK-15', '13:00:00', 'Boxing', 'Room A2', 'Lisa Park', '60 min', 14, 14,'blue', DATE_ADD(CURDATE(), INTERVAL 2 DAY), 'Hong Kong'),
('HK-16', '17:00:00', 'Strength', 'Room B1', 'David Kim', '55 min', 9, 9,'pink', DATE_ADD(CURDATE(), INTERVAL 2 DAY), 'Hong Kong');

-- Kowloon location classes
INSERT INTO classes (class_id, time, name, room, instructor, duration, spots, class_size,color, date, location) VALUES
('kl-1', '07:00:00', 'HIIT', 'Room K1', 'Tom Wong', '45 min', 10, 10,'blue', CURDATE(), 'Kowloon'),
('kl-2', '09:00:00', 'Yoga', 'Room K2', 'Lisa Chan', '60 min', 15, 15,'pink', CURDATE(), 'Kowloon'),
('kl-3', '11:00:00', 'Boxing', 'Room K1', 'Bruce Lam', '60 min', 8, 8,'green', CURDATE(), 'Kowloon');
